...
_Summary of this chapter_ 得再加一页
#v(20pt)
...
The implementation can be broadly divided into two main phases: offline and runtime. We precompute all the required triangle patterns in advance and upload them to GPU memory so that the compute shader can use them later, see Figure X.

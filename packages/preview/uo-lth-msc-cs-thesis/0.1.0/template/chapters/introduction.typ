...
Generating additional triangles in real-time on the GPU, so-call tessellation, is gradually becoming one of the solutions for rendering a large number of triangles in real-time. In the development of geometry processing technology in these decades, this concept has given rise to a wealth of research results and technical solutions @catmull1998recursively @loop1987smooth @boubekeur2005generic @lenz2009optimized @boubekeur2008phong @vlachos2001curved, especially Hardware Tessellation @microsoftd3d11features.
